...
public class OutGoing_order_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_out_going_order_);
        ...
        btnDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Outgoing_order b=new Outgoing_order(Integer.parseInt(id),"","",0);
                db.delete_outgoingorder(b);
                etorderid.setText("");
                etorderid.requestFocus();
        ...
        btnView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                tvData.setText("");
                ArrayList<Outgoing_order> a=new ArrayList();
                a=db.view_outgoing_order();
                if(a.size()==0)
                {
